...
import com.xupt.safeAndRun.modulespublic.common.utils.ScreenUtil;
...
//    }
    ...
    public void doDraw(Canvas canvas) {
        if (mItemHeight > 0) {
            int screenX = getWidth();
            int startX = screenX / 2 - mItemWidth / 2 - com.xupt.safeAndRun.modulespublic.common.utils.ScreenUtil.dpToPx(5);
            int stopX = mItemWidth + startX + com.xupt.safeAndRun.modulespublic.common.utils.ScreenUtil.dpToPx(5);
