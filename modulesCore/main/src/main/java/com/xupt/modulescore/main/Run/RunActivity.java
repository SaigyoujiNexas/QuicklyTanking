...
import com.xupt.modulescore.main.UI.View.ProgressButton;
...
public class RunActivity extends AppCompatActivity implements View.OnClickListener {
            ...
            public void onFinish() {
                ...
                call.enqueue(new Callback<BaseResponse<RunningRecord>>() {
                    ...
                    public void onFailure(Call<BaseResponse<RunningRecord>> call, Throwable t) {
                        ...
                        ToastUtil.INSTANCE.showToast("上传失败！保存到数据库中！");
    ...
    public void onClick(View view) {
        var id = view.getId();
        if(id == R.id.startRunButton){
                changeButtonState();
                locationBinder.startLocation();
                event.setRunning(true);
                EventBus.getDefault().post(event);
            }
        else if(id == R.id.stopRunButton) {
                changeButtonState();
